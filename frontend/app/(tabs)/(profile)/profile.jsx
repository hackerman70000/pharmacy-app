        ...
        {isLoggedIn ? (
          <View className='w-full items-center justify-center h-full gap-6 pt-4 px-8 max-w-[1000px] self-center'>
            <View className='w-full flex-row items-center justify-between'>
              <Text className='text-3xl text-primary font-bold self-start'>Your profile:</Text>
              <IconButton
                icon="logout"
                size={32}
                color="#10B981"
            ...
            <View className='w-full items-start justify-center gap-2'>
              <Text className='text-xl font-bold text-text-dark self-start'>Username:</Text>
              <Text className='text-xl text-text-light font-semibold self-start'>{profileInfo.username}</Text>
              <Text className='text-xl font-bold text-text-dark self-start'>Email:</Text>
              <Text className='text-xl text-text-light font-semibold self-start'>{profileInfo.email}</Text>
            </View>
            <Text className='text-3xl text-primary font-bold self-start'>Your orders:</Text>
            {orderItems}
            {orders.length === 0 && (
              <Text className='text-xl text-text-light font-semibold text-center'>
